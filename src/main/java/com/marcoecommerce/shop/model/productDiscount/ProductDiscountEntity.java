...
public class ProductDiscountEntity {
    ...
    private List<ProductDiscountLinkEntity> productLinkList = new ArrayList<>();

    public void addProduct(ProductEntity product) {
        ProductDiscountLinkEntity link = ProductDiscountLinkEntity.builder()
                .discount(this)
                .product(product)
                .build();
    ...
    public void removeProduct(ProductEntity product) {
        ProductDiscountLinkEntity link = this.productLinkList.stream()
        ...
        if (link != null) {
            System.out.println(link.getDiscount().getName());
            System.out.println(link.getProduct().getName());
    ...
    public List<ProductEntity> getProductList() {
        return this.productLinkList
                .stream()
                .map(ProductDiscountLinkEntity::getProduct)
